...
HD_PWD='C:/Vivado_project/PR_VER/LAB_1/pr1/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kuz_apb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kuz_apb.tcl
