...
HD_PWD='C:/Design_projects/PR_VER/Coursework/Temperature Sensor/Temperature Sensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log temp_sens_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temp_sens_top.tcl
