...
HD_PWD='C:/Design_projects/PR_VER/Coursework/Temperature Sensor/Temperature Sensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log temp_sens_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source temp_sens_top.tcl -notrace
