...
#define KUZNECHIK_BASE_ADDR           ( SOC_PERIPHERALS_BASE_ADDR + 0x8000 )
#define TEMP_SENS_BASE_ADDR           ( SOC_PERIPHERALS_BASE_ADDR + 0x9000 )
...
/** Clock gate FLL */
#define CGFLL     0x07
/** Clock gate Kuznechik cipher module */
#define CGKUZ     0x08
/** Clock gate Temperature Senser module */
#define CGTS      0x09
