...
pciproject:     file format elf64-x86-64
...
0000000000001070 <rand@plt>:
    ...
    1074:	f2 ff 25 55 2f 00 00 	bnd jmp *0x2f55(%rip)        # 3fd0 <rand@GLIBC_2.2.5>
...
0000000000001080 <_start>:
    ...
    1098:	48 8d 3d 23 01 00 00 	lea    0x123(%rip),%rdi        # 11c2 <main>
...
0000000000001169 <pciStatus>:
    1169:	f3 0f 1e fa          	endbr64 
    116d:	55                   	push   %rbp
    116e:	48 89 e5             	mov    %rsp,%rbp
    1171:	48 83 ec 10          	sub    $0x10,%rsp
    1175:	e8 f6 fe ff ff       	call   1070 <rand@plt>
    117a:	99                   	cltd   
    117b:	c1 ea 1e             	shr    $0x1e,%edx
    117e:	01 d0                	add    %edx,%eax
    1180:	83 e0 03             	and    $0x3,%eax
    1183:	29 d0                	sub    %edx,%eax
    1185:	89 45 fc             	mov    %eax,-0x4(%rbp)
    1188:	8b 45 fc             	mov    -0x4(%rbp),%eax
    118b:	c9                   	leave  
    118c:	c3                   	ret    

000000000000118d <printControllerStatus>:
    118d:	f3 0f 1e fa          	endbr64 
    1191:	55                   	push   %rbp
    1192:	48 89 e5             	mov    %rsp,%rbp
    1195:	48 83 ec 10          	sub    $0x10,%rsp
    1199:	b8 00 00 00 00       	mov    $0x0,%eax
    119e:	e8 c6 ff ff ff       	call   1169 <pciStatus>
    11a3:	89 45 fc             	mov    %eax,-0x4(%rbp)
...
00000000000011c2 <main>:
    ...
    11ce:	89 7d fc             	mov    %edi,-0x4(%rbp)
    11d1:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
    11d5:	b8 00 00 00 00       	mov    $0x0,%eax
    11da:	e8 ae ff ff ff       	call   118d <printControllerStatus>
