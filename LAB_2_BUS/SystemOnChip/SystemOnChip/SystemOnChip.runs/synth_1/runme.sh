...
HD_PWD='C:/Vivado_project/PR_VER/SystemOnChip/SystemOnChip/SystemOnChip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kuznechik_cipher_apb_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kuznechik_cipher_apb_wrapper.tcl
