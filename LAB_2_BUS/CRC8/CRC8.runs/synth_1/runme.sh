...
HD_PWD='C:/Design_projects/PR_VER/LAB_2_BUS/CRC8/CRC8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wrapper_crc8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wrapper_crc8.tcl
